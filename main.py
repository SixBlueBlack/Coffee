    ...
    def table(self):
        ...
        if self.a:
            for elem in self.a:
                ...
                self.tableWidget.setItem(rowPosition, 1, QTableWidgetItem(str(elem[1])))
                self.tableWidget.setItem(rowPosition, 2, QTableWidgetItem(str(elem[2])))
                self.tableWidget.setItem(rowPosition, 3, QTableWidgetItem(str(elem[3])))
                self.tableWidget.setItem(rowPosition, 4, QTableWidgetItem(str(elem[4])))
